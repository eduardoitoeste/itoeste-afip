...
class ElectronicBilling extends AfipWebService {
	...
	**/
	 ...
	 * 	voucher]
	**/
	public function CrearProximaFactura($data)
	{
		$last_voucher = $this->GetLastFactura($data['PtoVta'], $data['CbteTipo']);
	...
	**/
	public function GetFacturaInfo($number, $sales_point, $type)
	{
		$req = array(
			'FeCompConsReq' => array(
				'CbteNro' 	=> $number,
